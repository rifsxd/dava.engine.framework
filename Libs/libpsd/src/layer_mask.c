...
extern void psd_layer_levels_free(psd_ptr info_data);
extern psd_status psd_get_layer_curves(psd_context * context, psd_layer_record * layer, psd_int data_length);
extern void psd_layer_curves_free(psd_ptr info_data);
...
extern void psd_layer_gradient_map_free(psd_ptr info_data);
...
extern void psd_layer_type_tool_free(psd_ptr info_data);
extern void psd_layer_vector_mask_free(psd_layer_record * layer);
extern void psd_layer_effects_free(psd_ptr layer_info);
