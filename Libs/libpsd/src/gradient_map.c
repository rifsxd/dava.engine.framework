...
typedef void psd_adjustment_blend_proc(psd_ptr layer_info_data, psd_int * red, psd_int * green, psd_int * blue);
extern void psd_adjustment_blend_color(psd_context * context, psd_layer_record * layer, psd_rect * dst_rect, 
	psd_adjustment_blend_proc * blend_proc, psd_ptr layer_info_data);
...
void psd_layer_gradient_map_free(psd_ptr info_data)
{
	psd_layer_gradient_map * data;
...
static void psd_gradient_map_proc(psd_ptr layer_info_data, psd_int * red, psd_int * green, psd_int * blue)
{
