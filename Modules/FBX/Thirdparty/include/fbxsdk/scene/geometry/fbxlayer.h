...
public:
    ...
    */
    ...
    /** Grants a locked access to the data buffer. 
	  ...
	  */
    template <class T>
    inline T* GetLocked(T*, ELockMode pLockMode = eReadWriteLock)
    {
        T v;
    ...
    /** Removes the specified item from the data buffer.
      ...
      */
    template <class T>
    inline void RemoveAt(int pIndex, T* pItem)
    {
        T** voidPtr = &pItem;
    ...
    /** Removes the last item from the data buffer.    
      ...
      */
    template <class T>
    inline void RemoveLast(T* pItem)
    {
        T** voidPtr = &pItem;
    ...
    /** Returns the specified item's value.  
      ...
      */
    template <class T>
    inline bool GetAt(int pIndex, T* pItem) const
    {
        T** voidPtr = &pItem;
    ...
    /** Returns the first item's value.  
      ...
      */
    template <class T>
    inline bool GetFirst(T* pItem) const
    {
        T** voidPtr = &pItem;
    ...
    /** Returns the last item's value.  
      ...
      */
    template <class T>
    inline bool GetLast(T* pItem) const
    {
        T** voidPtr = &pItem;
    ...
    /** Searches for an item in the data buffer.  
      ...
      */
    template <class T>
    inline int Find(T const& pItem) const
    {
    ...
    /** Searches for an item after the specified index in the data buffer.  
      ...
      */
    template <class T>
    inline int FindAfter(int pAfterIndex, T const& pItem) const
    {
    ...
    /** Searches for one item before the specified index in the data buffer.  
      ...
      */
    template <class T>
    inline int FindBefore(int pBeforeIndex, T const& pItem) const
    {
    ...
    /** Copies the items in the data buffer to an array.
      ...
      */
    template <typename T>
    inline void CopyTo(FbxArray<T>& pDst)
    {
        T src;
        T* srcPtr = &src;
...
template <class T>
inline FbxLayerElementArrayTemplate<T>& FbxGetDirectArray(FbxLayerElementUserData* pLayerElement, int pIndex, bool* pStatus = NULL);
template <class T>
inline FbxLayerElementArrayTemplate<T> const& FbxGetDirectArray(FbxLayerElementUserData const* pLayerElement, int pIndex, bool* pStatus = NULL);
template <class T>
inline FbxLayerElementArrayTemplate<T>& FbxGetDirectArray(FbxLayerElementUserData* pLayerElement, const char* pName, bool* pStatus = NULL);
template <class T>
inline FbxLayerElementArrayTemplate<T> const& FbxGetDirectArray(FbxLayerElementUserData const* pLayerElement, const char* pName, bool* pStatus = NULL);
...
public:
    ...
    void ResizeAllDirectArrays(int pSize)
    {
        for (int i = 0; i < GetDirectArray().GetCount(); ++i)
        {
            ...
            {
            case eFbxBool:
                FbxGetDirectArray<bool>(this, i).Resize(pSize);
                break;
            case eFbxInt:
                FbxGetDirectArray<int>(this, i).Resize(pSize);
                break;
            case eFbxFloat:
                FbxGetDirectArray<float>(this, i).Resize(pSize);
                break;
            case eFbxDouble:
                FbxGetDirectArray<double>(this, i).Resize(pSize);
                break;
    ...
    void RemoveFromAllDirectArrays(int pIndex)
    {
        for (int i = 0; i < GetDirectArray().GetCount(); ++i)
        {
            ...
            {
            case eFbxBool:
                FbxGetDirectArray<bool>(this, i).RemoveAt(pIndex);
                break;
            case eFbxInt:
                FbxGetDirectArray<int>(this, i).RemoveAt(pIndex);
                break;
            case eFbxFloat:
                FbxGetDirectArray<float>(this, i).RemoveAt(pIndex);
                break;
            case eFbxDouble:
                FbxGetDirectArray<double>(this, i).RemoveAt(pIndex);
                break;
    ...
    int GetArrayCount(int pIndex) const
    {
        if (pIndex >= 0 && pIndex < GetDirectArray().GetCount())
        {
            ...
            {
            case eFbxBool:
                return FbxGetDirectArray<bool>(this, pIndex).GetCount();
            case eFbxInt:
                return FbxGetDirectArray<int>(this, pIndex).GetCount();
            case eFbxFloat:
                return FbxGetDirectArray<float>(this, pIndex).GetCount();
            case eFbxDouble:
                return FbxGetDirectArray<double>(this, pIndex).GetCount();
    ...
    void Init()
    {
        ...
        for (i = 0; i < mDataTypes.GetCount(); ++i)
        {
            ...
            if (dst)
            {
                ...
                {
                case eFbxBool:
                    dst[i] = (FbxHandle*)FbxNew<FbxLayerElementArrayTemplate<bool>>(mDataTypes[i].GetType());
                    break;
                case eFbxInt:
                    dst[i] = (FbxHandle*)FbxNew<FbxLayerElementArrayTemplate<int>>(mDataTypes[i].GetType());
                    break;
                case eFbxFloat:
                    dst[i] = (FbxHandle*)FbxNew<FbxLayerElementArrayTemplate<float>>(mDataTypes[i].GetType());
                    break;
                case eFbxDouble:
                    dst[i] = (FbxHandle*)FbxNew<FbxLayerElementArrayTemplate<double>>(mDataTypes[i].GetType());
                    break;
                default:
