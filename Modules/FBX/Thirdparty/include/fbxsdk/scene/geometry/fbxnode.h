...
*****************************************************************************************************************************/
    ...
    public:
        ...
        inline void SetQuaternionInterpolate(int id, EFbxQuatInterpMode pV)
        {
            ...
            if (mIsDefault[id] && pV == eQuatInterpOff)
                return;
            mIsDefault[id] = false;
        ...
        inline void SetRotationOrder(int id, EFbxRotationOrder pROrder)
        {
            ...
            // return to avoid allocating memory for the pivot (in Get(id).)
            if (mIsDefault[id] && pROrder == eEulerXYZ)
                return;
            mIsDefault[id] = false;
        ...
        {
            FBX_ASSERT(id == 0 || id == 1);
            if (pVal == FbxNode::ePivotReference)
                return;
            mPivotState[id] = pVal;
            if (mPivot[id])
...
inline EFbxType FbxTypeOf(const EFbxRotationOrder&)
{
    return eFbxEnum;
}
inline EFbxType FbxTypeOf(const FbxTransform::EInheritType&)
{
    return eFbxEnum;
}
inline EFbxType FbxTypeOf(const EFbxQuatInterpMode&)
{
    return eFbxEnum;
}
