...
inline EFbxType FbxTypeOf(const FbxCharacter::EAutoUser&)
{
    return eFbxEnum;
}
inline EFbxType FbxTypeOf(const FbxCharacter::EPostureMode&)
{
    return eFbxEnum;
}
inline EFbxType FbxTypeOf(const FbxCharacter::EFloorPivot&)
{
    return eFbxEnum;
}
inline EFbxType FbxTypeOf(const FbxCharacter::ERollExtractionMode&)
{
    return eFbxEnum;
}
inline EFbxType FbxTypeOf(const FbxCharacter::EHipsTranslationMode&)
{
    return eFbxEnum;
}
inline EFbxType FbxTypeOf(const FbxCharacter::EFootContactType&)
{
    return eFbxEnum;
}
inline EFbxType FbxTypeOf(const FbxCharacter::EHandContactType&)
{
    return eFbxEnum;
}
inline EFbxType FbxTypeOf(const FbxCharacter::EFingerContactMode&)
{
    return eFbxEnum;
}
inline EFbxType FbxTypeOf(const FbxCharacter::EContactBehaviour&)
{
    return eFbxEnum;
}
