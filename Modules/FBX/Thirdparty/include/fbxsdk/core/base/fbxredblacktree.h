...
public:
    ...
    */
    ...
    {
    public:
        inline ConstKeyType& GetKey() const
        {
            return mData.GetKey();
        }
        inline ConstValueType& GetValue() const
        {
        ...
        inline const int GetBlackDepth()
        {
            return mBlackDepth;
        }
...
public:
    ...
    inline FbxRedBlackTree()
        : mRoot(0)
        , mSize(0)
        , mAllocator(sizeof(RecordType))
    {
    }
    inline FbxRedBlackTree(const FbxRedBlackTree& pTree)
        : mRoot(0)
        , mSize(0)
        , mAllocator(sizeof(RecordType))
    {
