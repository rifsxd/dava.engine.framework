...
public:
    ...
    /** Set time in internal format.
		  ...
		  */
    inline void Set(FbxLongLong pTime)
    {
        mTime = pTime;
    }
    ...
    /** Set time in milliseconds.
		  ...
		  */
    inline void SetMilliSeconds(FbxLongLong pMilliSeconds)
    {
    ...
    /** Get time in milliseconds.
		  * \return Time value.
		  */
    inline FbxLongLong GetMilliSeconds() const
    {
    ...
    /** Equality operator.
		  ...
		  */
    inline bool operator==(const FbxTime& pTime) const
    {
...
public:
    ...
    /** Set start and stop time.
	  ...
	  * \param pStop  Ending of the time interval.
	  */
    inline void Set(FbxTime pStart, FbxTime pStop)
    {
        mStart = pStart;
        mStop = pStop;
    }
    ...
    /** Set start time.
	  * \param pStart Beginning of the time interval.
	  */
    inline void SetStart(FbxTime pStart)
    {
        mStart = pStart;
    }
    ...
    /** Set stop time.
	  * \param pStop  Ending of the time interval.
	  */
    inline void SetStop(FbxTime pStop)
    {
        mStop = pStop;
    }
    ...
    /** Get time interval in absolute value.
	  ...
	  */
    inline FbxTime GetDuration() const
    {
        if (mStop > mStart)
            return mStop - mStart;
        else
    ...
    /** Get time interval.
	  ...
	  */
    inline FbxTime GetSignedDuration() const
    {
        return mStop - mStart;
    }
    ...
    {
        if (mStop >= mStart)
            return FBXSDK_TIME_FORWARD;
        else
            return FBXSDK_TIME_BACKWARD;
    }
