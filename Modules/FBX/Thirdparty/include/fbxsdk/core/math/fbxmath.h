...
public:
    ...
    static inline double DegenerateThreshold()
    {
        return FbxEuler::mDegenerateThreshold;
    }
...
template <class T>
inline T FbxSign(const T x)
{
    return (x < 0) ? T(-1) : T(1);
}

template <class T>
inline T FbxRound(const T x)
{
    T y = FbxFloor(x);
...
template <class T>
inline T FbxAbs(const T x)
{
    return (x >= 0) ? x : ((x > FbxMin(x)) ? -x : FbxMax(x));
}

template <class T>
inline T FbxClamp(const T value, const T min, const T max)
{
    return (value < min) ? min : ((value > max) ? max : value);
}

template <class T>
inline bool FbxEqual(const T x, const T y, const T e = (T)FBXSDK_TOLERANCE)
{
    return FbxAbs(x - y) <= e;
}
...
template <class T>
inline T FbxReciprocal(const T x)
{
    return T(1) / x;
}
...
template <class T>
inline T FbxPow(const T x, const T y)
{
    return (T)FbxExp(y * FbxLog((double)x));
}

template <class T>
inline T FbxLog2(const T x)
{
...
// *y = cos(x), sin(x)
template <class T>
inline T FbxSinCos(const T x, T* y)
{
...
template <class T>
inline T FbxSinCosd(const T x, T* y)
{
...
template <class T>
inline T FbxATand(const T y, const T x)
{
    return (T)(FbxATan(y, x) * FBXSDK_180_DIV_PI);
}

template <class T>
inline T FbxNorm(const T x, const T y)
{
    return FbxSqrt(x * x + y * y);
}

template <class T>
inline T FbxNorm(const T x, const T y, const T z)
{
    return FbxSqrt(x * x + y * y + z * z);
}

template <class T>
inline T FbxNorm(const T w, const T x, const T y, const T z)
{
    return FbxSqrt(w * w + x * x + y * y + z * z);
}

template <class T>
inline T FbxHypot(const T x, const T y)
{
    return FbxSqrt(x * x + y * y);
}

template <class T>
inline T FbxHypot(const T x, const T y, const T z)
{
    return FbxSqrt(x * x + y * y + z * z);
}

template <class T>
inline T FbxHypot(const T w, const T x, const T y, const T z)
{
    return FbxSqrt(w * w + x * x + y * y + z * z);
}
...
template <class T>
inline int FbxBitCount(const T x)
{
    int n = 0;
    T c = x;
    while (c)
...
template <class T>
inline void FbxFixInfinite(T& x)
{
...
template <class T>
inline T FbxExp(const T x);
template <class T>
inline T FbxLog(const T x);
template <class T>
inline T FbxSin(const T x);
template <class T>
inline T FbxCos(const T x);
template <class T>
inline T FbxASin(const T x);
template <class T>
inline T FbxACos(const T x);
template <class T>
inline T FbxATan(const T x);
template <class T>
inline T FbxATan(const T y, const T x);
