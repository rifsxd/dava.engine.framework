...
public:
	...
	* with the normal limits. */
    ...
    /** According the given value and its value type, set the minimum value and value type for this property.
		...
		*/
    template <class T>
    inline bool SetMin(const T& pValue)
    {
    ...
    template <class T>
    inline T GetMin(const T* pFBX_TYPE) const
    {
        T lValue;
        GetMin(&lValue, FbxTypeOf(lValue));
        return lValue;
    }
    ...
    /** According the given value and its value type, set the soft minimum value and value type for this property.
		...
		* \return If it be set successfully, return true,otherwise, return false. */
    template <class T>
    inline bool SetSoftMin(const T& pValue)
    {
    ...
    template <class T>
    inline T GetSoftMin(const T* pFBX_TYPE) const
    {
        T lValue;
        GetSoftMin(&lValue, FbxTypeOf(lValue));
        return lValue;
    }
    ...
    /** According the given value and its value type, set the maximum value and value type for this property.
		...
		* \return If it be set successfully, return true,otherwise, return false. */
    template <class T>
    inline bool SetMax(const T& pValue)
    {
    ...
    template <class T>
    inline T GetMax(const T* pFBX_TYPE) const
    {
        T lValue;
        GetMax(&lValue, FbxTypeOf(lValue));
        return lValue;
    }
    ...
    /** According the given value and its value type, set the soft maximum value and value type for this property.
		...
		* \return If it be set successfully, return true,otherwise, return false. */
    template <class T>
    inline bool SetSoftMax(const T& pValue)
    {
    ...
    template <class T>
    inline T GetSoftMax(const T* pFBX_TYPE) const
    {
        T lValue;
        GetSoftMax(&lValue, FbxTypeOf(lValue));
        return lValue;
    }
    //@}
	...
	*/
    ...
    template <class T>
    inline T Get(const T* pFBX_TYPE) const
    {
        T lValue;
