...
public:
    ...
    /** Assignment operator
	  ...
	  */
    inline FbxDataType& operator=(const FbxDataType& pDataType)
    {
        mTypeInfoHandle = pDataType.mTypeInfoHandle;
        return *this;
    }
    ...
    /** Equality operator
		  ...
		  */
    inline bool operator==(const FbxDataType& pDataType) const
    {
    ...
    /** Test if this datatype is the specified datatype. 
	  ...
	  */
    inline bool Is(const FbxDataType& pDataType) const
    {
    ...
    /** Retrieve the information handle of this data type.
	  ...
	  */
    inline const FbxPropertyHandle& GetTypeInfoHandle() const
    {
