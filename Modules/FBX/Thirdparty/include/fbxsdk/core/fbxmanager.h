...
public:
    ...
    inline FbxClassId RegisterFbxClass(const char* pName, const T1* /*T1*/, const T2* /*T2*/, const char* pFbxFileTypeName = 0, const char* pFbxFileSubTypeName = 0)
    {
    ...
    /** Runtime class registration.
		  ...
		  */
    template <typename T>
    inline FbxClassId RegisterRuntimeFbxClass(const char* pName, const T* /*T*/, const char* pFbxFileTypeName = 0, const char* pFbxFileSubTypeName = 0)
    {
    ...
    /** Override class.
		  ...
		  */
    template <typename T1, typename T2>
    inline FbxClassId OverrideFbxClass(const T1* pFBX_TYPE_Class, const T2* pFBX_TYPE_OverridenClass)
    {
    ...
    /** Class unregistration.
		  ...
		  */
    template <typename T>
    inline void UnregisterFbxClass(const T* pFBX_TYPE_Class)
    {
