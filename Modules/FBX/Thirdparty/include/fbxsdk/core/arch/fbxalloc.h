...
template <class Type>
class FbxDeletionPolicyDefault
{
public:
...
public:
    ...
    explicit FbxAutoPtr(Type* pPtr = 0)
        : mPtr(pPtr)
    {
    }
...
template <class Type>
class FbxAutoFreePtr : public FbxAutoPtr<Type, FbxDeletionPolicyFree<Type>>
{
public:
    //! Construct from a pointer.
    explicit FbxAutoFreePtr(Type* pPtr = 0)
...
template <class Type>
class FbxAutoDeletePtr : public FbxAutoPtr<Type, FbxDeletionPolicyDelete<Type>>
{
public:
    //! Construct from a pointer.
    explicit FbxAutoDeletePtr(Type* pPtr = 0)
...
template <class Type>
class FbxAutoDestroyPtr : public FbxAutoPtr<Type, FbxDeletionPolicyObject<Type>>
{
public:
    //! Construct from a pointer.
    explicit FbxAutoDestroyPtr(Type* pPtr = 0)
...
//! Scoped pointer for FbxMalloc allocations, which call FbxFree() to deallocate.
template <class Type>
class FbxSharedFreePtr : public FbxSharedPtr<Type, FbxDeletionPolicyFree<Type>>
{
public:
    //! Construct from a pointer.
    explicit FbxSharedFreePtr(Type* pPtr = 0)
        : FbxSharedPtr<Type, FbxDeletionPolicyFree<Type>>(pPtr)
    {
    }
};
...
//! Scoped pointer for FbxNew allocations, which call FbxDelete() to deallocate.
template <class Type>
class FbxSharedDeletePtr : public FbxSharedPtr<Type, FbxDeletionPolicyDelete<Type>>
{
public:
    //! Construct from a pointer.
    explicit FbxSharedDeletePtr(Type* pPtr = 0)
        : FbxSharedPtr<Type, FbxDeletionPolicyDelete<Type>>(pPtr)
    {
    }
};
...
//! Scoped pointer for FbxObject derived classes, which call Destroy() to deallocate.
template <class Type>
class FbxSharedDestroyPtr : public FbxSharedPtr<Type, FbxDeletionPolicyObject<Type>>
{
public:
    //! Construct from a pointer.
    explicit FbxSharedDestroyPtr(Type* pPtr = 0)
        : FbxSharedPtr<Type, FbxDeletionPolicyObject<Type>>(pPtr)
    {
    }
};
