...
inline const FbxChar FbxMin(const FbxChar)
{
    return FBXSDK_CHAR_MIN;
}
inline const FbxUChar FbxMin(const FbxUChar)
{
    return FBXSDK_UCHAR_MIN;
}
inline const FbxShort FbxMin(const FbxShort)
{
    return FBXSDK_SHORT_MIN;
}
inline const FbxUShort FbxMin(const FbxUShort)
{
    return FBXSDK_USHORT_MIN;
}
inline const FbxInt FbxMin(const FbxInt)
{
    return FBXSDK_INT_MIN;
}
inline const FbxUInt FbxMin(const FbxUInt)
{
    return FBXSDK_UINT_MIN;
}
inline const FbxLongLong FbxMin(const FbxLongLong)
{
    return FBXSDK_LONGLONG_MIN;
}
inline const FbxULongLong FbxMin(const FbxULongLong)
{
    return FBXSDK_ULONGLONG_MIN;
}
inline const FbxFloat FbxMin(const FbxFloat)
{
    return FBXSDK_FLOAT_MIN;
}
inline const FbxDouble FbxMin(const FbxDouble)
{
    return FBXSDK_DOUBLE_MIN;
}

inline const FbxChar FbxMax(const FbxChar)
{
    return FBXSDK_CHAR_MAX;
}
inline const FbxUChar FbxMax(const FbxUChar)
{
    return FBXSDK_UCHAR_MAX;
}
inline const FbxShort FbxMax(const FbxShort)
{
    return FBXSDK_SHORT_MAX;
}
inline const FbxUShort FbxMax(const FbxUShort)
{
    return FBXSDK_USHORT_MAX;
}
inline const FbxInt FbxMax(const FbxInt)
{
    return FBXSDK_INT_MAX;
}
inline const FbxUInt FbxMax(const FbxUInt)
{
    return FBXSDK_UINT_MAX;
}
inline const FbxLongLong FbxMax(const FbxLongLong)
{
    return FBXSDK_LONGLONG_MAX;
}
inline const FbxULongLong FbxMax(const FbxULongLong)
{
    return FBXSDK_ULONGLONG_MAX;
}
inline const FbxFloat FbxMax(const FbxFloat)
{
    return FBXSDK_FLOAT_MAX;
}
inline const FbxDouble FbxMax(const FbxDouble)
{
    return FBXSDK_DOUBLE_MAX;
}

#ifndef FBXSDK_SYSTEM_IS_LP64
inline const FbxLong FbxMin(const FbxLong)
{
    return FBXSDK_LONG_MIN;
}
inline const FbxULong FbxMin(const FbxULong)
{
    return FBXSDK_ULONG_MIN;
}
inline const FbxLong FbxMax(const FbxLong)
{
    return FBXSDK_LONG_MAX;
}
inline const FbxULong FbxMax(const FbxULong)
{
...
template <class T>
inline const T FbxMin(const T){};
template <class T>
inline const T FbxMax(const T){};

template <class T>
inline T FbxMin(const T x, const T y)
{
    return (x < y) ? x : y;
}
template <class T>
inline T FbxMax(const T x, const T y)
{
    return (x > y) ? x : y;
}
...
template <class T>
class FBXSDK_DLL FbxVectorTemplate2
{
public:
    ...
    inline explicit FbxVectorTemplate2(T pValue)
    {
        *this = pValue;
    }
    inline FbxVectorTemplate2(T pData0, T pData1)
    {
        mData[0] = pData0;
        mData[1] = pData1;
    }
    ...
    inline T& operator[](int pIndex)
    {
        return mData[pIndex];
    }
    inline const T& operator[](int pIndex) const
    {
        return mData[pIndex];
    }
    inline FbxVectorTemplate2<T>& operator=(const T& pValue)
    {
        mData[0] = pValue;
        mData[1] = pValue;
        return *this;
    }
    inline FbxVectorTemplate2<T>& operator=(const FbxVectorTemplate2<T>& pVector)
    {
        mData[0] = pVector.mData[0];
        mData[1] = pVector.mData[1];
        return *this;
    }
    inline bool operator==(const FbxVectorTemplate2<T>& pVector) const
    {
...
template <class T>
class FBXSDK_DLL FbxVectorTemplate3
{
public:
    ...
    inline explicit FbxVectorTemplate3(T pValue)
    {
        *this = pValue;
    }
    inline FbxVectorTemplate3(T pData0, T pData1, T pData2)
    {
        mData[0] = pData0;
        mData[1] = pData1;
        mData[2] = pData2;
...
template <class T>
class FBXSDK_DLL FbxVectorTemplate4
{
public:
    ...
    inline explicit FbxVectorTemplate4(T pValue)
    {
        *this = pValue;
    }
    inline FbxVectorTemplate4(T pData0, T pData1, T pData2, T pData3)
    {
        mData[0] = pData0;
        mData[1] = pData1;
        mData[2] = pData2;
    ...
    inline FbxVectorTemplate4<T>& operator=(const FbxVectorTemplate3<T>& pValue)
    {
        mData[0] = pValue[0];
        mData[1] = pValue[1];
        mData[2] = pValue[2];
    ...
    inline FbxVectorTemplate4<T>& operator=(const FbxVectorTemplate4<T>& pVector)
    {
        mData[0] = pVector.mData[0];
        mData[1] = pVector.mData[1];
        mData[2] = pVector.mData[2];
        mData[3] = pVector.mData[3];
        return *this;
    }
    inline bool operator==(const FbxVectorTemplate4<T>& pVector) const
    {
