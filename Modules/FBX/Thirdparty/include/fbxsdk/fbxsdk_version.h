...
// macro for a 0 leading month and day
	...
	#define FBXSDK_VERSION_MONTH_STRING FBX_STRINGIFY(0) \
\
FBX_STRINGIFY(FBXSDK_VERSION_MONTH)
#else
	#define FBXSDK_VERSION_MONTH_STRING FBX_STRINGIFY(FBXSDK_VERSION_MONTH)
#endif
#if FBXSDK_VERSION_DAY < 10
	#define FBXSDK_VERSION_DAY_STRING FBX_STRINGIFY(0) \
\
FBX_STRINGIFY(FBXSDK_VERSION_DAY)
#else
...
#define FBXSDK_VERSION_DATE FBX_STRINGIFY(FBXSDK_VERSION_YEAR) \
\
"" FBXSDK_VERSION_MONTH_STRING "" FBXSDK_VERSION_DAY_STRING
