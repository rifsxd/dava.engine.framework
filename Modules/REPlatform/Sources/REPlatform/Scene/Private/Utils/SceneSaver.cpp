...
void SceneSaver::SetTags(const Vector<String>& tags_)
{
...
void SceneSaver::CopyTextures(Scene* scene)
{
...
void SceneSaver::CopySlots(Entity* node, Set<FilePath>& externalScenes)
{
    using namespace DAVA;
...
void SceneSaver::ProcessSprite(Sprite* sprite)
{
    using namespace DAVA;
