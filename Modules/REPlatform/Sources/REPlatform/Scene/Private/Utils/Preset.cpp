...
QString GetSavePathname(const QString& caption, const String& folder)
{
    ...
    params.filters = presetFilter;
    params.dir = QString::fromStdString(folderPath.GetAbsolutePathname());

    return Deprecated::GetUI()->GetSaveFileName(DAVA::mainWindowKey, params);
}
...
QString GetOpenPathname(const QString& caption, const String& folder)
{
    ...
    return Deprecated::GetUI()->GetOpenFileName(DAVA::mainWindowKey, params);
}
