...
namespace DAVA
{
const SlotTemplatesData::Template* SlotTemplatesData::GetTemplate(FastName name) const
{
...
Vector<SlotTemplatesData::Template> SlotTemplatesData::GetTemplates() const
{
    Vector<Template> result;
...
void SlotTemplatesData::ParseConfig(const FilePath& configPath)
{
...
{
    ReflectionRegistrator<SlotTemplatesData>::Begin()
    .End();
}
} // namespace DAVA
