...
#define FMOD_EVENT_VERSION 0x00044464
...
typedef struct FMOD_EVENT_SYSTEMINFO
{
    ...
    FMOD_EVENT_SYSTEMINFO()
        ...
        , playingevents(0)
    {
        numloadsqueued[0] = numloadsqueued[1] = numloadsqueued[2] = numloadsqueued[3] = numloadsqueued[4] = 0;
    }
#endif
...
typedef struct FMOD_EVENT_LOADINFO
{
    ...
    FMOD_EVENT_LOADINFO()
        : size(0)
        , encryptionkey(0)
        , sounddefentrylimit(0)
        , loadfrommemory_length(0)
        , override_category_vals(0)
        , sizeof_instancepool_simple(0)
    {
    }
#endif
