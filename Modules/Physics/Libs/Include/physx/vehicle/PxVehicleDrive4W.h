...
public:
    PxVehicleDriveSimData4W(const PxEMPTY)
        : PxVehicleDriveSimData(PxEmpty)
        , mDiff(PxEmpty)
        , mAckermannGeometry(PxEmpty)
    {
    }
...
protected:
    ...
    {
        return !::strcmp("PxVehicleDrive4W", name) || PxBase::isKindOf(name);
    }
...
public:
    ...
    PxVehicleDrive4W(PxBaseFlags baseFlags)
        ...
        , mDriveSimData(PxEmpty)
    {
    }
    virtual const char* getConcreteTypeName() const
    {
        return "PxVehicleDrive4W";
    }
    //~serialization
};
