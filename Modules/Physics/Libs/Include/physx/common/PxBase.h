...
public:
	...
	*/
    ...
    {
        mBaseFlags = value ? mBaseFlags | flag : mBaseFlags & ~flag;
    }
	...
	*/
    ...
    {
        return mBaseFlags & PxBaseFlag::eIS_RELEASABLE;
    }
...
protected:
	...
	*/
    ...
    bool typeMatch() const
    {
        ...
        PxU32(getConcreteType()) == PxU32(PxTypeInfo<T>::eFastTypeId) :
