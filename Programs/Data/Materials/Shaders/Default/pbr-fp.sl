...
fragment_out
{
    ...
    uniform sampler2D baseColorMap; // RGB - albedo color, A - alpha    //PBR
    ...
    #endif
    [material][a] property float4 baseColorFactor             = float4(1.0, 1.0, 1.0, 1.0); //Painting base textures
    [material][a] property float2 roughnessMetallicFactor     = float2(1.0, 1.0); //Roughness setting
